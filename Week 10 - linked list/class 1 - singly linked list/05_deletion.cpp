...
//todo - deletion 
void deletion(int position , Node* &head , Node* &tail , int length){
    if(position < 1 || position > length){
        cout << "enter the valid position to delete" << endl ; 
    }
        ...
        if(position == 1 ){
            ...
            // deleting except position 1 ; 
            //! finding the previous position 
            Node* temp = head ; 
            for(int i =0 ; i <position - 2 ; i++){
                temp = temp -> next ; 
            }
...
int main()
{
    ...
    length = getlength(head) ; 
    deletion(3,head,tail,length) ;
    print(head) ;  

    length = getlength(head) ; 
    deletion(1,head,tail,length) ;
    print(head) ;  

    length = getlength(head) ; 
    deletion(10,head,tail,length) ;
    print(head) ;  
